...
SELECT
    ...
    sm.DefaultUnitAI,
    --DefaultUnitAI
    ('TXT_KEY_UNIT_NTF_SOUNPEI'),
    --Description
    ('TXT_KEY_UNIT_NTF_SOUNPEI_PEDIA'),
    --Civilopedia
    ('TXT_KEY_UNIT_NTF_SOUNPEI_HELP'),
    --Help
    ('TXT_KEY_UNIT_NTF_SOUNPEI_STRATEGY'),
    --Strategy
    hm.AdvancedStartCost,
    ('ART_DEF_UNIT_NTF_SOUNPEI'),
    --UnitArtInfo
    0,
    ('NTF_SOUNPEI_FLAG'),
    --UnitFlagAtlas
...
FROM
    Units hm
    join Units sm on 1 = 1
WHERE
    (hm.Type = 'UNIT_HORSEMAN')
    and (sm.Type = 'UNIT_SWORDSMAN');
...
VALUES
    ('UNIT_NTF_SOUNPEI', 'PROMOTION_AMPHIBIOUS'),
    (
        'UNIT_NTF_SOUNPEI',
        'PROMOTION_CAN_MOVE_AFTER_ATTACKING'
    ),
    ('UNIT_NTF_SOUNPEI', 'PROMOTION_WITHDRAW');

-- will add lua to rmove this promotion when it is used, and replace it with PROMOTION_HEAVY_ATTACK
--==========================================================================================================================
