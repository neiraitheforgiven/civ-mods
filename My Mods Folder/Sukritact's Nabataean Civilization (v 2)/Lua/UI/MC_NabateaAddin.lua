...
local tFlavor = {
		'TXT_KEY_TRAIT_MC_NABATEA_FLAVOR_1',
		'TXT_KEY_TRAIT_MC_NABATEA_FLAVOR_2',
		'TXT_KEY_TRAIT_MC_NABATEA_FLAVOR_3',
		'TXT_KEY_TRAIT_MC_NABATEA_FLAVOR_4',
		'TXT_KEY_TRAIT_MC_NABATEA_FLAVOR_5',
	}	
--==========================================================================================================================
-- GAMEPLAY FUNCTIONS
--==========================================================================================================================
...
function UpdateNabateaBox()
	...
	if Players[iPlayer]:HasPolicy(GameInfoTypes.POLICY_DECISIONS_NABATEANGARDENS) then
		...
		Controls.BuyButton:LocalizeAndSetToolTip("TXT_KEY_TRAIT_MC_NABATEA_TOOLTIP", iCost, iNum * 2)		
	end
