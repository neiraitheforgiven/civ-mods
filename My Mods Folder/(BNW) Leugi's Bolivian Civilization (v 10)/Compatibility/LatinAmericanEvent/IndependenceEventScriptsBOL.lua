...
-- Author: Leugi
--=======================================================================================================================
print("Leugi's Latin American Event: loaded for Bolivia")
--=======================================================================================================================
--------------------------------------------------------------------------------------------------------------------------
local Event_Leugi_Bolivia_Independence = {}
	Event_Leugi_Bolivia_Independence.Name = "TXT_KEY_EVENT_LATIN_AMERICAN_INDEPENDENCE"
	Event_Leugi_Bolivia_Independence.Desc = "TXT_KEY_EVENT_LATIN_AMERICAN_INDEPENDENCE_DESC"
	Event_Leugi_Bolivia_Independence.Weight = 0
	Event_Leugi_Bolivia_Independence.CanFunc = (
		function(pPlayer)
			--
			...
			--
			-- Fire the Event!
			Event_Leugi_Bolivia_Independence.Desc = Locale.ConvertTextKey("TXT_KEY_EVENT_LATIN_AMERICAN_INDEPENDENCE_DESC")
		
			return true
		end
		)
	Event_Leugi_Bolivia_Independence.Outcomes = {}
	--=========================================================
	-- Outcome 1
	--=========================================================
	Event_Leugi_Bolivia_Independence.Outcomes[1] = {}
	Event_Leugi_Bolivia_Independence.Outcomes[1].Name = "TXT_KEY_EVENT_LATIN_AMERICAN_INDEPENDENCE_OUTCOME_1"
	Event_Leugi_Bolivia_Independence.Outcomes[1].Desc = "TXT_KEY_EVENT_LATIN_AMERICAN_INDEPENDENCE_OUTCOME_RESULT_1"
	Event_Leugi_Bolivia_Independence.Outcomes[1].Weight = 1
	Event_Leugi_Bolivia_Independence.Outcomes[1].CanFunc = (
		function(pPlayer)			
			Event_Leugi_Bolivia_Independence.Outcomes[1].Desc = Locale.ConvertTextKey("TXT_KEY_EVENT_LATIN_AMERICAN_INDEPENDENCE_OUTCOME_CUBA_RESULT_1")
			return true
		end
		)
	Event_Leugi_Bolivia_Independence.Outcomes[1].DoFunc = (
		function(pPlayer) 
			pPlayer:ChangeGoldenAgeTurns(30)
			InitUnitFromCity(pPlayer:GetCapitalCity(), GameInfoTypes.UNIT_LIBERTADOR, 1)
...
Events_AddCivilisationSpecificScheduled(GameInfoTypes["CIVILIZATION_BOLIVIA"], "Event_Leugi_Bolivia_Independence", Event_Leugi_Bolivia_Independence, 1810, true)
