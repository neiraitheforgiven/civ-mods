...
SELECT  'LEADER_NTF_JOSEF',	'POLICY_AGGRESSIVE_X',	'POLICY_DIPLOMATIC_X'
...
SELECT	'CIVILIZATION_NTF_NEZ_PERCE',		ArtDefineTag, CultureType, SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
...
VALUES	('LEADER_NTF_JOSEF',		'FLAVOR_JFD_DECOLONIZATION',		 10),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_MERCENARY',				 7),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 4),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_REFORM_GOVERNMENT',		 4), --Scale of Liberal to Authoritarian.
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_REFORM_LEGAL',			 3), 	
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_REFORM_CULTURE',		 5),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_REFORM_ECONOMIC',		 2),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_REFORM_EDUCATION',	 	 3),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_REFORM_FOREIGN',		 6),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_REFORM_INDUSTRY',		 4),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_REFORM_MILITARY',		 6),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_REFORM_RELIGION',		 2),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_SLAVERY',				 7),
		('LEADER_NTF_JOSEF',		'FLAVOR_JFD_STATE_RELIGION',		 4);
--==========================================================================================================================
...
--WHERE CivilizationType = 'CIVILIZATION_NTF_NEZ_PERCE'
...
VALUES  ('CIVILIZATION_NTF_NEZ_PERCE',		'AMERICAN',	       'ANCIENT');
--==========================================================================================================================
-- R.E.D. / Ethnic Units
--==========================================================================================================================
-- Civilizations
...
SET ArtStyleSuffix = (CASE WHEN EXISTS(SELECT ArtStyleSuffix FROM Civilizations WHERE ArtStyleSuffix = '_RUSSIA' )
    THEN '_IROQUOIS'
    ELSE '_AMER' END)
WHERE TYPE = 'CIVILIZATION_NTF_NEZ_PERCE';
--==========================================================================================================================
-- YnAEMP v25
--==========================================================================================================================
...
VALUES	('CIVILIZATION_NTF_NEZ_PERCE',	'Yagem',				154, 68),
		('CIVILIZATION_NTF_NEZ_PERCE',	'Yahem',				31,	 56),
		('CIVILIZATION_NTF_NEZ_PERCE',	'Cordiform',			16,	 35),
		('CIVILIZATION_NTF_NEZ_PERCE',	'GreatestEarth',		18,	 51),
		('CIVILIZATION_NTF_NEZ_PERCE',	'EarthMk3',				151, 74),
		('CIVILIZATION_NTF_NEZ_PERCE',	'AmericasGiant',		65,	 123),
		('CIVILIZATION_NTF_NEZ_PERCE',	'Americas',				47,	 56),
		('CIVILIZATION_NTF_NEZ_PERCE',	'AtlanticGiant',		71,	 79),
		('CIVILIZATION_NTF_NEZ_PERCE',	'NorthAmericaGiant',	93,	 59),
		('CIVILIZATION_NTF_NEZ_PERCE',	'NorthAmericaHuge',		91,	 45),
		('CIVILIZATION_NTF_NEZ_PERCE',	'NorthAtlantic',		15,	 41);
--==========================================================================================================================
--==========================================================================================================================