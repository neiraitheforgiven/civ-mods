-- JFD_Nationalism_NationalismFunctions
-- Author: JFD
...
-- STARTUP POPUP
------------------------------------------------------------------------------------------------------------------------
--JFD_Nationalism_LoadScreenClose
local function JFD_Nationalism_LoadScreenClose()
	if activePlayer:GetCapitalCity() then return end
	ContextPtr:SetHide(false)
end
Events.LoadScreenClose.Add(JFD_Nationalism_LoadScreenClose)
------------------------------------------------------------------------------------------------------------------------
--UI_InitNationalismPopup()
local function UI_InitNationalismPopup()
