-- JFD_PrisonersWar_PrisonersWarFunctions
-- Author: JFD
...
-- STARTUP POPUP
------------------------------------------------------------------------------------------------------------------------
--JFD_PrisonersWar_LoadScreenClose
local function JFD_PrisonersWar_LoadScreenClose()
	if activePlayer:GetCapitalCity() then return end
	ContextPtr:SetHide(false)
end
Events.LoadScreenClose.Add(JFD_PrisonersWar_LoadScreenClose)
------------------------------------------------------------------------------------------------------------------------
--UI_InitPrisonersWarPopup()
local function UI_InitPrisonersWarPopup()
